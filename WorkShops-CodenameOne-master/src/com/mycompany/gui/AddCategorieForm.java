...
Form current;
    public AddCategorieForm(Resources res) {
        ...
        super("Ajouter Catégorie", BoxLayout.y());
        ...
        addTab(swipe, res.getImage("news-item.jpg"), spacer1, "", "", "Bienvenue dans nos espace de méditation.");
        ...
        RadioButton Categorie = RadioButton.createToggle("Catégorie", barGroup);
