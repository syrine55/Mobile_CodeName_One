 ...
 * @author Mohamed
 */
public class UpdateIMCForm extends BaseForm{
      Form current;
    public UpdateIMCForm(Resources res,IMC imc){
      super("Newsfeed",BoxLayout.y());
      Toolbar tb=new Toolbar(true);
      current=this;
      setToolbar(tb);
      getTitleArea().setUIID("Container");
      setTitle("Modifier IMC");
            ...
            if (objet1.getText()==""||objet2.getText()==""){
               Dialog.show("Erreur","Veuillez verifier vos données", "Annuler", "ok");
                ...
                final Dialog d=ip.showInfiniteBlocking();
                 IMC imc1=new IMC();
                 imc1.setPoids(Double.valueOf(objet1.getText()));
                 imc1.setTaille(Double.valueOf(objet2.getText()));
                 ServiceIMC.getInstance().updateIMC(imc1, imc.getId());
                d.dispose();
