 ...
 */
public class ListConsommation extends BaseForm {
    
    Form current ;
    public ListConsommation (Resources res) {
  ...
  super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
        ...
        setTitle("Consulter votre consommation") ;
        ...
        // special case for rotation
         ...
         partage.addActionListener(e -> new AddConsommation(res).show());
  ...
  Button bntChart  = new Button("Chart ") ;
  SpanLabel sp = new SpanLabel();
  container1=ServicesConsommation.getInstance().getAllGestionEau();
  bntChart.addActionListener(e-> new ChartConsommation(current).show() );
