 ...
 * @author timou
 */
public class AjouterCategorierecette extends BaseForm{
    Form current;
    public AjouterCategorierecette(Resources res){
...
mesListes.addActionListener((e) -> {
  ...
  liste.addActionListener((e) -> {
    refreshTheme();
       ...
       //////////////////////////////////////
      TextField objet=new TextField("","Saisir votre categorie");
        ...
        try{
            if (objet.getText()==""){
               Dialog.show("Erreur","Veuillez verifier vos données", "Annuler", "ok");
                ...
                Categorierecette c=new Categorierecette(String.valueOf(objet.getText()).toString());
                CategorierecetteService.getInstance().addCat(c);
                d.dispose();
