 ...
 * @author timou
 */
public class UpdateCategorierecetteForm extends BaseForm{
    Form current;
    public UpdateCategorierecetteForm(Resources res,Categorierecette c){
...
mesListes.addActionListener((e) -> {
    ...
    refreshTheme();
       ...
       //////////////////////////////////////
      TextField objet=new TextField(c.getNom(),"Saisir votre categorie");
        ...
        try{
            if (objet.getText()==""){
               Dialog.show("Erreur","Veuillez verifier vos données", "Annuler", "ok");
                ...
                c.setNom(objet.getText());
                 InfiniteProgress ip=new  InfiniteProgress();
                final Dialog d=ip.showInfiniteBlocking();
                 CategorierecetteService.getInstance().modifierCat(c);
                d.dispose();
