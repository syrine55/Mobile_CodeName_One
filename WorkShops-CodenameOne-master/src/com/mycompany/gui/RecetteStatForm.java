 ...
 */
 ...
 public class RecetteStatForm extends Form{
   
    public RecetteStatForm(Form previous) {
        getStyle().setBgColor(0x2D2D2D);
       int max=RecetteService.getInstance().getAllnbERParCategorie().size();
      ArrayList<Long> med=RecetteService.getInstance().getAllnbERParCategorie();
    ...
    protected CategorySeries buildCategoryDataset(String title, double[] values) {
        ...
        int k = 0;
         ArrayList<String> cat=RecetteService.getInstance().getAllParCategorie();
